...
export default function CtaCard() {
  return (
    <div className='flex flex-col'>
      ...
      <p className='text-start text-sm md:text-lg text-wrap opacity-70 m-4 mb-0 leading-10'>
      ...
      <div className='flex justify-start gap-10 m-4'>
        <button className='bg-accent text-sm md:text-lg hover:bg-foreground hover:text-background  text-primary font-semibold py-2 px-4 rounded-full mt-4 transition-all duration-300 ease-in-out'>
